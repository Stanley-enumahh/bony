  ...
  return (
    ...
    >
      <div className="flex flex-row h-full justify-between w-[90%] md:w-[78%]">
        <div className="flex flex-col items-start relative gap-24 md:gap-14 mt-4 md:mt-[60px] w-full md:w-[50%] text-white">
          <h1 className="md:text-8xl HIB text-5xl font-mailray font-bold leading-[50px] md:leading-[110px] md:text-start text-center">
            welcome to <br />{" "}
            <span className="font-mailray text-6xl md:text-[130px]">$Bony</span>
          </h1>
          ...
          <span className="font-bold font-jellee md:text-start w-[80%] md:w-[90%] text-xs md:text-lg flex text-center flex-row gap-3 md:mb-0 mb-7 z-20">
        ...
        <div className="w-full md:flex hidden bottom-0 bg-red-300 items-start static justify-center z-10 md:w-[43%] h-fit md:mt-0">
          <img
            src={CatImage}
            alt=""
            className="w-[50%] md:w-full h-[90%] object-cover"
