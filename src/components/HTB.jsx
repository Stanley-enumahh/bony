...
export default function HowToBuy() {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-[85%] md:w-[55%] rotate-[-1deg] bg-white justify-end items-center mt-6 rounded-[60px] md:rounded-xl navbar-shadow">
        <span className="md:px-10 px-4 justify-center items-center py-5 md:py-3 flex flex-col md:flex-row gap-5 md:gap-10 w-full">
          <p className="font-bold text-center text-xs md:text-lg font-jellee">
            {textToCopy}
          </p>
          <button
            onClick={handleCopy}
            className="bg-[#6f6e6e] hover:bg-opacity-80 shadow-obj text-white px-8 md:px-10 py-3 rounded-[26px] md:rounded-md font-bold font-jellee"
          >
            {copied ? "Copied!" : "Copy"}
          </button>
        </span>
      ...
      <div className="flex w-[55%] rotate-[-1deg] py-2  justify-end items-center bg-transparent">
        <span className="flex bg-white px-10 py-3 justify-center rounded-[36px]  md:rounded-xl navbar-shadow">
          <a
            href="https://firstledger.net/"
            className="bg-[#6f6e6e] md:ml-[40px] shadow-obj text-white px-6 py-3 hover:bg-opacity-80 md:rounded-md rounded-[26px] font-bold"
          >
            Buy now
          </a>
        </span>
